    ...
    <div className="py-8 max-w-5xl mx-auto px-4 space-y-8">
      ...
      <div>
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-destructive/30 bg-destructive/10 px-8 py-10 flex flex-col items-center text-center gap-3">
            <AlertCircle className="size-8 text-destructive/70" />
            <div className="space-y-1">
              <p className="font-medium text-sm">Bots konnten nicht geladen werden</p>
              <p className="text-[12px] text-muted-foreground max-w-sm">{dbError}</p>
            </div>
          </div>
        ) : bots.length === 0 ? (
