...
export default function BuilderPage() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-3.25rem)]">
      ...
      {/* ── Unified toolbar ──────────────────────────────────────────────── */}
      <div className="flex items-center gap-2 border-b border-border/70 bg-card/50 px-3 py-1.5 shrink-0">
        ...
        {mode === "components" && (
          <div className="flex items-center gap-0.5">
            ...
            <Button
              ...
              className={cn("h-7 gap-1.5 text-xs text-muted-foreground hover:text-foreground", showTemplates && "bg-accent text-foreground")}
        ...
        {mode === "cog" && (
          <div className="flex items-center gap-2">
            ...
            <Input
              ...
              className="w-40 font-mono text-xs h-7 bg-background"
            />
          </div>
        )}
